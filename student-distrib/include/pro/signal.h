...
static int32_t send_signal(thread_t *thread, int8_t signum);
static int32_t add_mask(thread_t *thread, int signum);
static int32_t remove_mask(thread_t *thread, int signum);
